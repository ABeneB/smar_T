...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { company_id: @tour.company_id, driver_id: @tour.driver_id, duration: @tour.duration, user_id: @tour.user_id }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { company_id: @tour.company_id, driver_id: @tour.driver_id, duration: @tour.duration, user_id: @tour.user_id }
    assert_redirected_to tour_path(assigns(:tour))
  end
